...
local ps = love.graphics.newParticleSystem(images.particle, 1000)
...
ps = love.graphics.newParticleSystem(images.particle, 500)
...
ps = love.graphics.newParticleSystem(images.particle, 1000)
